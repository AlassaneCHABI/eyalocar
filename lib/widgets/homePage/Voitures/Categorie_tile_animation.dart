              ...
              children: [
                ...
                Container(
                    child:Align(
                        ...
                        child:voiture.status=="Pending"? Text(
                ...
                Container(
                    child:Align(
                        ...
                        child:
                        Text(
                            "  Année minimum : "+ voiture.year_minimum.toString(),
                ...
                Container(
                    child:Align(
                      ...
                      child:Row(
                          children:[
                            Text(
                                "  Année maximum : "+ voiture.year_maximum.toString(),
                                style: TextStyle(fontSize: 15)//AppTheme.of(context).bodyText1,
                            ), SizedBox(width: 20,),
                            SizedBox(width: 20,),
                          ]
                ...
                Container(
                    child:Align(
                      alignment: Alignment.centerLeft,
                      child:Text(
                          "  Budget: "+ voiture.budget.toString()+" fcfa",
                          style: TextStyle(fontSize: 15)//AppTheme.of(context).bodyText1,
                      ),
                    )
                ...
                Container(
                    child:Align(
                      alignment: Alignment.centerLeft,
                      child:Text(
                          "  Date: "+ formatDateTime(voiture.created_at),
                          style: TextStyle(fontSize: 15)//AppTheme.of(context).bodyText1,
                      ),
                    )
                      ...
                      child:Container(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () async{
                            ...
                            ): voiture.status=="Not available"?
                            showDialog(
                              context: context,
                              builder: (BuildContext ctx) {
                                return AlertDialog(
                                  title: Text("Alerte"),
                                  content: Text("Pas de véhicule disponible pour cette demande", textAlign: TextAlign.center,),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
                                        Navigator.pop(ctx);
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context) => FoundCarsListScreen(request_id: voiture.id)));
                          },
