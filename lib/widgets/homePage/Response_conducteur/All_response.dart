...
import 'package:eyav2/widgets/homePage/Response_conducteur/Reponse_conducteur_liste.dart';
...
class ConducteurResponseListingWidget extends StatefulWidget {
  int request_id;

  ConducteurResponseListingWidget({Key? key,required this.request_id}) : super(key: key);

  @override
  _ConducteurListingWidgetState createState() => _ConducteurListingWidgetState();
}

class _ConducteurListingWidgetState extends State<ConducteurResponseListingWidget> {
  TextEditingController? textController;
  final scaffoldKey = GlobalKey<ScaffoldState>();
  bool isSearchStarted = false;

  List<Conducteur_reponse> searchedVoitures = [];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Nos conducteurs", style: TextStyle(fontFamily: "Ubuntu", fontSize: 22, fontWeight: FontWeight.bold),),
        backgroundColor: Colors.white,
        elevation: 0,
      ...
      body:conducteur.length==0?Center(child: CircularProgressIndicator(),):  Column(
        ...
        children: [
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (_) => EasyDebounce.debounce(
                            ...
                            Duration(milliseconds: 0),
                              ...
                              if (isSearchStarted) {
                                ...
                                searchedVoitures = conducteur
                                    .where((item) =>
                                    item.driver_city.toLowerCase().contains(textController!.text.trim().toLowerCase()))
                                    .toList();
                              }
                              setState(() {});
                            },
                          ...
                          decoration: InputDecoration(
                            labelText: 'Rechercher par ville ici...',
          ...
          Expanded(
            child: ConducteurListResponse(
              conducteur: isSearchStarted ? searchedVoitures: conducteur,
            ),
          ),
        ],
      ),
