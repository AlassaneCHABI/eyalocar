...
import 'package:eyav2/widgets/homePage/Categorie/Categorie_liste.dart';

import 'package:flutter/material.dart';

import 'package:eyav2/function/function.dart' as function;

class CategorieListingWidget extends StatefulWidget {

  CategorieListingWidget({Key? key}) : super(key: key);

  @override
  _CategorieListingWidgetState createState() => _CategorieListingWidgetState();
}

class _CategorieListingWidgetState extends State<CategorieListingWidget> {
  ...
  void initState() {
    ...
    super.initState();
    function.getCategorie().then((value){
      if(value!=null){
        setState(() {
          categorie.addAll(value);
        });
      }
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          "Nos categories de véhicule ",
          style: TextStyle(fontSize: 19),
        ),
        elevation: 0,
        backgroundColor: kPrimaryColor,
      ),
      body:categorie.length==0?Center(child: CircularProgressIndicator()):  Column(
        ...
        children: [
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Rechercher les categories ici...',
          ...
          Expanded(
            child: CategorieList(
              categorie: isSearchStarted ? searchedCategory: categorie,
            ),
          ),
        ],
      ),
