...
class _UsagePolicyState extends State<UsagePolicy> {
  ...
  void initState() {
    ...
    _controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://eyalocar.com/politique-utilisation'));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Politique d'utilisation", style: TextStyle(fontFamily: "Ubuntu", fontSize: 22, fontWeight: FontWeight.bold),),
