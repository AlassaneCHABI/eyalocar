...
class Cooki extends StatefulWidget {
  const Cooki({super.key});

  @override
  State<Cooki> createState() => _CookiState();
}

class _CookiState extends State<Cooki> {
  ...
  void initState() {
    ...
    _controller = WebViewController()
      ...
      ..loadRequest(Uri.parse('https://eyalocar.com/politique-cookies'));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Politique de cookies", style: TextStyle(fontFamily: "Ubuntu", fontSize: 22, fontWeight: FontWeight.bold),),
